          ...
          <div className="row g-0 bg-secondary">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <Link to="/liveReport" className="btn btn-info">Live</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <Link to="/victim" className="btn btn-info">Victim</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <Link to="/witnessForm" className="btn btn-info">Witness</Link>
              </div>
            </div>
          </div>
        </div>
