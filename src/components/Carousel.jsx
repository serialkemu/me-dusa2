      ...
      <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="300">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={car2} className="d-block w-100" alt="stop sgbv"/>
          </div>
          <div className="carousel-item">
            <img src={car1} className="d-block w-100" alt="stop sgbv"/>
          </div>
          <div className="carousel-item">
            <img src={car3} className="d-block w-100" alt="stop sgbv"/>
          </div>
        </div>
